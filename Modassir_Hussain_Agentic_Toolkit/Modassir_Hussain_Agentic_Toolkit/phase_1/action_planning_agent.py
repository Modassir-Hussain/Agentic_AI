...
# TODO: 2 - Load environment variables and define the openai_api_key variable
load_dotenv()
...
# TODO: 4 - Print the agent's response to the prompt
prompt = "One morning I wanted to have scrambled eggs"
extracted_steps = planning_agent.extract_steps_from_prompt(prompt)
